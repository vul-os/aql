  ...
  return (
    <AdminToastProvider>
      <PageHeader
        ...
        description="Observe and moderate this Aql deployment — every account, user, and gate movement on the instance."
      />
  ...
  return (
    <div className="max-w-lg mx-auto mt-[12vh]">
      <Card className="p-8 text-center">
        ...
        <p className="text-sm text-ink/60 leading-relaxed">
          This console belongs to whoever runs this Aql instance. Your account doesn't have
