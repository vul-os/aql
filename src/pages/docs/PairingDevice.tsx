...
blink red       relay miswired or short detected`}</CodeBlock>
      ...
      <DocSection heading="Under the hood">
        ...
        <CodeBlock lang="http" title="device → hub">{`POST /v1/devices/dev_oak_main/open HTTP/1.1
Host: your-hub.example.com
Authorization: Bearer lintel_dev_session_xxxxxxxxxxxx
...

{
  ...
  "signature": "ed25519:dN3w…/L8w=="
        ...
        <p>
          The hub verifies the signature, checks the nonce hasn&rsquo;t been used in the last
