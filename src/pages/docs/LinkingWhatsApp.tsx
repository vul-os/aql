...
export default function LinkingWhatsApp() {
    ...
    <>
      ...
      <DocSection heading="The link flow">
        <ol className="list-decimal pl-6 space-y-3">
          ...
          <li>You&rsquo;ll receive a 6-digit code. Reply to the hub&rsquo;s verification message with that code from the number you want to link. The hub never stores your message contents.</li>
  ...
  "verified_at": "2026-05-14T09:21:04Z"
        ...
        <p>
          The hub doesn&rsquo;t store messages, conversation history, contacts, or media. Inbound messages
      ...
      <DocSection heading="Programmatic check">
        ...
        <CodeBlock lang="bash">{`curl -H "Authorization: Bearer lintel_live_xxxxxxxxxxxxxxxx" \\
  https://<your-hub>/v1/phones/me`}</CodeBlock>
        <CodeBlock lang="json">{`{
  "phones": [
    {
      "phone_e164": "+27821234567",
