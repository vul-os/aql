...
export default function BotManagementPage() {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          performed_by: maintenanceForm.performed_by || user?.user_metadata?.full_name || 'Admin',
  ...
  const filteredRecords = records.filter(record => {
    return (
      ...
      record.performed_by?.toLowerCase().includes(maintenanceSearchQuery.toLowerCase()) ||
                    ...
                    <TableBody>
                      {filteredRecords.map((record) => (
                        <TableRow key={record.id}>
                          <TableCell className="whitespace-nowrap">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {format(new Date(record.performed_at), 'h:mm a')}
                              </p>
                            </div>
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell className="text-sm">{record.performed_by || 'N/A'}</TableCell>
                          <TableCell className="text-right">
                            {record.cost ? (
                              <span className="font-bold">R{parseFloat(record.cost).toFixed(2)}</span>
                            ) : (
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="grid gap-6">
                ...
                <div className="space-y-3">
                  <Label className="text-base font-semibold">Bot Status</Label>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground flex items-center gap-1">
                    ...
                    Transfer this bot to a different location
                  </p>
                </div>
                ...
                {botForm.location_id && (
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="none">
                          <span className="text-muted-foreground italic">Not assigned to any garden</span>
                        </SelectItem>
                        {gardens
                    ...
                    <p className="text-xs text-muted-foreground">
                      Which specific garden this bot will service at the location
                    </p>
                  </div>
                )}
