      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="wire-grid-success" width="100" height="100" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#wire-grid-success)" />
          </svg>
        </div>
        <Card className="w-full max-w-md relative z-10 border-accent/20 shadow-glow-orange">
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Your account has been created successfully. Initializing dashboard...
            </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="wire-grid-signup" width="100" height="100" patternUnits="userSpaceOnUse">
              <path d="M 100 0 L 0 0 0 100" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-accent"/>
              <circle cx="0" cy="0" r="2" fill="currentColor" className="text-accent"/>
              <circle cx="100" cy="0" r="2" fill="currentColor" className="text-accent"/>
              <circle cx="0" cy="100" r="2" fill="currentColor" className="text-accent"/>
          ...
          <rect width="100%" height="100%" fill="url(#wire-grid-signup)" />
        </svg>
      </div>

      {/* Floating Wire Connectors */}
      <div className="absolute top-10 right-10 opacity-20 animate-float">
        <WireConnectorIcon />
      </div>
      <div className="absolute bottom-10 left-10 opacity-20 animate-float" style={{ animationDelay: '1.5s' }}>
        <WireConnectorIcon />
      </div>
      ...
      <Card className="w-full max-w-md relative z-10 border-accent/20 shadow-glow-orange">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-lg mt-2">Establish New Connection</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">Existing Connection</span>
              </div>
            </div>
