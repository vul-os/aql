    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="wire-grid" width="100" height="100" patternUnits="userSpaceOnUse">
      ...
      <Card className="w-full max-w-md relative z-10 border-accent/20 shadow-glow-orange">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-lg mt-2">Connect to Your Dashboard</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">New Connection</span>
              </div>
            </div>
