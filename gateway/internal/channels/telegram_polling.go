...
// part of the key. Flip LINTEL_TELEGRAM_ENGINE either way and a message
...
// ResolveTelegramEngine turns the raw LINTEL_TELEGRAM_ENGINE env value into a
...
const TelegramPollingAuthenticityNotice = "LINTEL_TELEGRAM_ENGINE=polling selected: inbound Telegram updates are " +
