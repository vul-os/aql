...
// ResolveWhatsAppEngine turns the raw AQL_WHATSAPP_ENGINE env value into a
...
const WhatsAppBanRiskWarning = "AQL_WHATSAPP_ENGINE=bridge selected: this uses an UNOFFICIAL WhatsApp Web " +
