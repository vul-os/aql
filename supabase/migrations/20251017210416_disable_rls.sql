...
-- Disable RLS on services and rental agreements
ALTER TABLE services DISABLE ROW LEVEL SECURITY;
ALTER TABLE master_rental_agreements DISABLE ROW LEVEL SECURITY;
ALTER TABLE rental_agreements DISABLE ROW LEVEL SECURITY;
ALTER TABLE rental_agreement_amendments DISABLE ROW LEVEL SECURITY;
ALTER TABLE service_cancellation_requests DISABLE ROW LEVEL SECURITY;

-- Disable RLS on billing
...
-- Disable RLS on service records and schedules
ALTER TABLE service_records DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS service_schedules DISABLE ROW LEVEL SECURITY;
