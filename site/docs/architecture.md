...
| --- | --- | --- | --- |
| **hub** (`hub/`) | The entire server: the open path, console, API, device hub, audit | **Shipped** — 131 routes, 1,306 test functions green | Go · SQLite (`modernc.org/sqlite`, no CGO) · embedded console |
