...
| --- | --- | --- | --- |
| **hub** (`hub/`) | The entire server: the open path, console, API, device hub, audit | **Shipped** — 136 routes, 1,402 test functions green | Go · SQLite (`modernc.org/sqlite`, no CGO) · embedded console |
