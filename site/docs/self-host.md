...
> `open` works today over WhatsApp, Slack or Telegram — 136 HTTP routes registered in
> `hub/internal/httpapi/server.go`, and over a thousand Go test functions across 20
