...
The hub is 136 HTTP routes and 1,475 Go test functions; the controller agent is 221
more; the wire contracts have 84 conformance vectors (119 checks) that both sides are
tested against.
