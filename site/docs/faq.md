...
The hub is 127 HTTP routes and 1,192 Go test functions; the controller agent is 142
more; the wire contracts have 75 conformance vectors (110 checks) that both sides are
tested against.
