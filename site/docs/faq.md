...
The hub is 129 HTTP routes and 1,261 Go test functions; the controller agent is 188
more; the wire contracts have 76 conformance vectors (111 checks) that both sides are
tested against.
