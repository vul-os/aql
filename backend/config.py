...
# Get your service role key from: https://app.supabase.com/project/kyoowsarfopltjwmhksi/settings/api
...
RESEND_API_KEY = os.environ.get('RESEND_API_KEY', 're_Wr7jYKK2_Ax1ZQhyi3JLbpYFVDUD6JMaD')
