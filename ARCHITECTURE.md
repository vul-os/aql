...
| Layer | Status |
| --- | --- |
| Hub (`hub/`) — open path, console, API, device hub, audit | **Built.** 134 HTTP routes, 1,380 Go test functions green across 20 packages |
...
│   └── migrations/   # SQLite schema, clean folded baseline (32 migrations, 57 tables)
