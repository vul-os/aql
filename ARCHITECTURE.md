...
| Layer | Status |
| --- | --- |
| Hub (`hub/`) — open path, console, API, device hub, audit | **Built.** 126 HTTP routes, 1,095 Go test functions green across 18 packages |
...
| Controller agent (`controller/`) — pairing, signed commands, grants, events | **Built.** 135 Go test functions green. GPIO relay driver and BLE radio are **not** |
