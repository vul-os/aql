...
| Layer | Status |
| --- | --- |
| Hub (`hub/`) — open path, console, API, device hub, audit | **Built.** 131 HTTP routes, 1,289 Go test functions green across 18 packages |
...
│   └── migrations/   # SQLite schema, clean folded baseline (31 migrations, 56 tables)
