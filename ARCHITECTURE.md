...
| Layer | Status |
| --- | --- |
| Hub (`hub/`) — open path, console, API, device hub, audit | **Built.** 131 HTTP routes, 1,283 Go test functions green across 18 packages |
...
│   └── migrations/   # SQLite schema, clean folded baseline (30 migrations, 55 tables)
